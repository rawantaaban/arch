...
@section('content')
 ...
 <div class="row" >
                            <div class="col-md-12" >
                            	<div class="card-box">
                            		<h4 class="m-t-0 header-title"><b style="font-family: 'Cairo'">تعديل بريد وارد</b></h4>
                            		<p class="text-muted m-b-30 font-13">
									</p>
									

                                   	<form id="basic-form" method="POST" action="{{ route('Import.update',$doc->id) }}" enctype="multipart/form-data">
                                         @csrf
                                         @method('PUT')
                                         ...
                                         <div>
                                            ...
                                            <section>
                                                <div class="form-group clearfix">
                                                    <label class="col-lg-2 control-label " for="doc_no">رقم الوارد *</label>
                                                    <div class="col-lg-10">
                                                        <input class="form-control required" id="doc_no" name="doc_no" type="number"  value="{{$doc->doc_no}}" >
                                                    </div>
                                                </div>
                                                <div class="form-group clearfix">
                                                    <label class="col-lg-2 control-label " for="doc_date"> تاريخ الوارد * </label>
                                                    <div class="col-lg-10">
