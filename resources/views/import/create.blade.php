...
@section('content')
 ...
 <div class="row" >
                            <div class="col-md-12" >
                            	<div class="card-box">
                            		<h4 class="m-t-0 header-title"><b style="font-family: 'Cairo'"> ادخال بريد وارد</b></h4>
                            		<p class="text-muted m-b-30 font-13">
									</p>
									
									<form id="basic-form" method="POST" action="{{ route('Import.store') }}" enctype="multipart/form-data">
                                          {{ csrf_field() }}
